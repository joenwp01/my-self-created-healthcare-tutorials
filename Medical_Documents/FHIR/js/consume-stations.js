...
const CONSUME_STATIONS = [
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("What you're looking for", `
      <ul>
      ...
      `)}
      ${UI.collapsible("The Cascade Regional HIE's Capability Statement", `
      ...
      `)}
      ${UI.collapsible("Why this matters more than it looks", `
...
<span class="pc-comment"># Response pending — click Run Station below</span></pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("What distinguishes Backend Services from user-facing SMART flows", `
      <ul>
      ...
      `)}
      ${UI.collapsible("What a real production pipeline does", `
...
<span style="color:#6aaed6;">// Token valid for 15 minutes. Next refresh at T-2min.</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("FHIR search in one paragraph", `
      ...
      `)}
      ${UI.collapsible("Three ways to pull a 5-patient cohort", `
      <ul>
      ...
      `)}
      ${UI.collapsible("Pagination — the part that trips up new pipelines", `
      ...
      `)}
      ${UI.collapsible("What comes back", `
...
Accept: application/fhir+json</pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("The kickoff / poll / download dance", `
      <ol>
      ...
      `)}
      ${UI.collapsible("Group-scoped vs. system-wide", `
      ...
      `)}
      ${UI.collapsible("Why not just use search everywhere?", `
      ...
      `)}
      ${UI.collapsible("Polling discipline", `
      ...
      `)}
      ${UI.collapsible("The Cascade cohort on $export", `
...
<span class="pc-comment"># Polling again in 30s...</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("What \"resolving\" actually means", `
      ...
      `)}
      ${UI.collapsible("Two ways to avoid dangling references at the source", `
      ...
      `)}
      ${UI.collapsible("The tradeoff between <code>_include</code> and follow-up fetches", `
      ...
      `)}
      ${UI.collapsible("Logical references — the trickier case", `
...
# Click "Run resolution" to execute</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("What a profile validator actually checks", `
      <ul>
      ...
      `)}
      ${UI.collapsible("The real failure modes — by frequency", `
      ...
      `)}
      ${UI.collapsible("The Cascade Cohort's incoming validation report", `
      ...
      `)}
      ${UI.collapsible("Quarantine vs. best-effort — the policy decision", `
...
# Click "Run validation" to execute against the 183 resources</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("What <code>$validate-code</code> does", `
      ...
      `)}
      ${UI.collapsible("Required vs. extensible — what failure means", `
      <ul>
      ...
      `)}
      ${UI.collapsible("The Cascade Cohort's incoming binding issues", `
      ...
      `)}
      ${UI.collapsible("Translate-then-check, or check-then-translate?", `
...
# Click "Run binding checks" to execute</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("The three classes of extension", `
      <ul>
      ...
      `)}
      ${UI.collapsible("The modifier extension exception", `
      ...
      `)}
      ${UI.collapsible("The Cascade Cohort's extension landscape", `
      ...
      `)}
      ${UI.collapsible("Policy decisions, in order of safety", `
      ...
      `)}
      ${UI.collapsible("What a working pipeline does with unrecognized non-modifier extensions", `
      <ul>
...
# Click "Process extensions" to execute</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("Three reconciliation cases, in increasing difficulty", `
      <ol>
      ...
      `)}
      ${UI.collapsible("The Cascade Cohort's near-duplicate: P001 vs. P005", `
      ...
      `)}
      ${UI.collapsible("Match score thresholds — a typical setup", `
      ...
      `)}
      ${UI.collapsible("Why not auto-merge \"possibles\"", `
      ...
      `)}
      ${UI.collapsible("Same-batch dose conflict — a different reconciliation case", `
...
# Click "Run reconciliation" to execute</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("Why FHIR doesn't load directly into a warehouse", `
      ...
      `)}
      ${UI.collapsible("The US Core warehouse target schema", `
      ...
      `)}
      ${UI.collapsible("The decision: how to handle one-to-many fields", `
      ...
      `)}
      ${UI.collapsible("The Cascade Cohort's flattening challenges", `
      <ul>
      ...
      `)}
      ${UI.collapsible("Three approaches to the one-to-many problem", `
      <ul>
...
# Click "Run flattening" to execute</span></pre>`;
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      ${UI.collapsible("The warehouse schema", `
      ...
      `)}
      ${UI.collapsible("What happens when you click \"Initialize warehouse\"", `
      <ol>
      ...
      `)}
      ${UI.collapsible("Try the suggested queries", `
      ...
      `)}
      ${UI.collapsible("What this station is NOT", `
      ...
      `)}
      ${UI.collapsible("The terminal decision", `
...
window.handleS2Choice = function(v) {
  ...
  Runtime.renderAll({ preserveScroll: true });  // postRender restores CSS class + feedback from state
};
