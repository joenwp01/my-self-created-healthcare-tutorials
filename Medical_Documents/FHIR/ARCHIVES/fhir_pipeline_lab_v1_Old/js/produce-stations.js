...
const PRODUCE_STATIONS = [
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>The operational truth: source data is messy</h4>
...
CRH-10001 | Gonzalez  | Maria      | 04/12/1963  | F   | 2106-3
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>What a profile does, concretely</h4>
      <ul>
      ...
      <h4>For the Cascade post-discharge summary, we need</h4>
      <ul>
      ...
      <h4>Why "just use base FHIR" is a trap</h4>
...
<span class="pc-comment"># No profile asserted yet. Which profile will we target?</span></pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>US Core Patient required elements (6.1.0)</h4>
      <ul>
      ...
      <h4>The race extension is more structured than it looks</h4>
      ...
      <h4>The "declined to report" case</h4>
      ...
      <h4>Narrative summary matters more than producers realize</h4>
...
<span class="pc-comment"># For P003 (Jamal Washington): raceOmbCode = ASKU — patient declined to report.</span></pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>Three ways to express a FHIR reference</h4>
      <ul>
      ...
      <h4>Contained vs. referenced — the older, still-useful mechanism</h4>
      ...
      <h4>The Practitioner decision for the Cascade post-discharge summary</h4>
      ...
      <h4>Why this matters for the transaction POST</h4>
...
MedicationRequest {
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>The four binding strengths</h4>
      <ul>
      ...
      <h4>The Cascade Cohort's terminology challenges</h4>
      ...
      <h4>The hard case: Robert Kowalski's legacy ICD-9 code</h4>
...
# ICD-9 is NOT in the bound ValueSet.</span></pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>The hierarchy of extension choices</h4>
      ...
      <h4>The Cascade Cohort's extension needs</h4>
      ...
      <h4>Walking the ladder for each</h4>
      <ul>
      ...
      <h4>Modifier extensions — the dangerous kind</h4>
      ...
      <h4>What "cost of a custom extension" actually means</h4>
...
# discharge_followup_urgency is the hard one.</span></pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>What FHIRPath looks like in practice</h4>
      ...
      <h4>Where invariants come from</h4>
      ...
      <h4>Local validation vs. server-side validation</h4>
      ...
      <h4>The Cascade Cohort's invariant trouble spots</h4>
      ...
      <h4>What does the producer do with invariant failures?</h4>
...
# Source data error in the EHR's encounter table.</span></pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>Why a separate validation pass at the end</h4>
      ...
      <h4>What "must-support" actually means at this stage</h4>
      ...
      <h4>Where things actually break at this gate</h4>
      ...
      before: () => `<pre class="code-block"><span class="pc-comment"># Final pre-submit validation report (HL7 FHIR Validator output)</span>
{
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>Bundle types — and why most producers should use only two</h4>
      <ul>
      ...
      <h4>Entry shape — the parts that matter</h4>
      <ul>
      ...
      <h4>The Cascade post-discharge submission</h4>
      ...
      <h4>The atomicity decision in detail</h4>
      ...
      before: () => `<pre class="code-block"><span class="pc-comment"># 30 resources ready for submission. 5 patients, ~6 resources each.</span>
{
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>The four operations and what they do</h4>
      <ul>
      ...
      <h4>What "matches" actually means — the criteria string</h4>
      ...
      <h4>The Cascade Cohort's conditional cases</h4>
      <ul>
      ...
      <h4>The near-duplicate case (P001/P005) returns</h4>
      ...
      <h4>The non-creative answer is the right one</h4>
...
P005 entry → Patient with identifier system="...mrn", value="CRH-10005"</pre>`,
     ...
     ============================================================ */
  {
    ...
    lecture: () => `
      ...
      <h4>What the POST returns on success</h4>
      ...
      <h4>What the POST returns on failure</h4>
      ...
      <h4>Atomic transaction failure mode</h4>
      ...
      <h4>The Cascade post-discharge submission outcome</h4>
      ...
      <h4>Decision: what to do about P002's failure</h4>
